      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div>
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-2xl font-semibold">Kəndlər</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li><Link to="/listings" className="hover:text-gold transition-colors">{t("nav.find")}</Link></li>
              <li><Link to="/listings" className="hover:text-gold transition-colors">{t("nav.villages")}</Link></li>
              <li><Link to="/listings" className="hover:text-gold transition-colors">{t("nav.activities")}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-background/70">
              <li><Link to="/host" className="hover:text-gold transition-colors">{t("nav.host")}</Link></li>
              <li><Link to="/host" className="hover:text-gold transition-colors">Kəndli olmaq</Link></li>
              <li><Link to="/host" className="hover:text-gold transition-colors">Komissiya</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-background/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-background/50">
            © {new Date().getFullYear()} Kəndlər. {t("footer.rights")}.
          </p>
